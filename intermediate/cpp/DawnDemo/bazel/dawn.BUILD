...
TINT_SRCS = [
    ...
    # From dawn/src/tint/BUILD.gn:libtint_base_src
    "src/tint/debug.cc",
    "src/tint/debug.h",
    ...
    "src/tint/utils/bump_allocator.h",
    "src/tint/utils/castable.cc",
    "src/tint/utils/castable.h",
    ...
    "src/tint/utils/parse_num.cc",
    "src/tint/utils/parse_num.h",
    ...
    "src/tint/utils/traits.h",
    "src/tint/utils/transform.h",
    "src/tint/utils/unicode.cc",
    "src/tint/utils/unicode.h",
    "src/tint/utils/unique_allocator.h",
    "src/tint/utils/unique_vector.h",
    "src/tint/utils/vector.h",

    # From dawn/src/tint/BUILD.gn:libtint_clone_context_hdrs
    "src/tint/clone_context.h",

    # From dawn/src/tint/BUILD.gn:libtint_program_src
    ...
    # From dawn/src/tint/BUILD.gn:libtint_transform_src
    "src/tint/ast/transform/add_block_attribute.cc",
    "src/tint/ast/transform/add_block_attribute.h",
    "src/tint/ast/transform/add_empty_entry_point.cc",
    "src/tint/ast/transform/add_empty_entry_point.h",
    "src/tint/ast/transform/array_length_from_uniform.cc",
    "src/tint/ast/transform/array_length_from_uniform.h",
    "src/tint/ast/transform/binding_remapper.cc",
    "src/tint/ast/transform/binding_remapper.h",
    "src/tint/ast/transform/builtin_polyfill.cc",
    "src/tint/ast/transform/builtin_polyfill.h",
    "src/tint/ast/transform/calculate_array_length.cc",
    "src/tint/ast/transform/calculate_array_length.h",
    "src/tint/ast/transform/canonicalize_entry_point_io.cc",
    "src/tint/ast/transform/canonicalize_entry_point_io.h",
    "src/tint/ast/transform/clamp_frag_depth.cc",
    "src/tint/ast/transform/clamp_frag_depth.h",
    "src/tint/ast/transform/combine_samplers.cc",
    "src/tint/ast/transform/combine_samplers.h",
    "src/tint/ast/transform/decompose_memory_access.cc",
    "src/tint/ast/transform/decompose_memory_access.h",
    "src/tint/ast/transform/decompose_strided_array.cc",
    "src/tint/ast/transform/decompose_strided_array.h",
    "src/tint/ast/transform/decompose_strided_matrix.cc",
    "src/tint/ast/transform/decompose_strided_matrix.h",
    "src/tint/ast/transform/demote_to_helper.cc",
    "src/tint/ast/transform/demote_to_helper.h",
    "src/tint/ast/transform/direct_variable_access.cc",
    "src/tint/ast/transform/direct_variable_access.h",
    "src/tint/ast/transform/disable_uniformity_analysis.cc",
    "src/tint/ast/transform/disable_uniformity_analysis.h",
    "src/tint/ast/transform/expand_compound_assignment.cc",
    "src/tint/ast/transform/expand_compound_assignment.h",
    "src/tint/ast/transform/first_index_offset.cc",
    "src/tint/ast/transform/first_index_offset.h",
    "src/tint/ast/transform/fold_trivial_lets.cc",
    "src/tint/ast/transform/fold_trivial_lets.h",
    "src/tint/ast/transform/for_loop_to_loop.cc",
    "src/tint/ast/transform/for_loop_to_loop.h",
    "src/tint/ast/transform/localize_struct_array_assignment.cc",
    "src/tint/ast/transform/localize_struct_array_assignment.h",
    "src/tint/ast/transform/merge_return.cc",
    "src/tint/ast/transform/merge_return.h",
    "src/tint/ast/transform/module_scope_var_to_entry_point_param.cc",
    "src/tint/ast/transform/module_scope_var_to_entry_point_param.h",
    "src/tint/ast/transform/multiplanar_external_texture.cc",
    "src/tint/ast/transform/multiplanar_external_texture.h",
    "src/tint/ast/transform/num_workgroups_from_uniform.cc",
    "src/tint/ast/transform/num_workgroups_from_uniform.h",
    "src/tint/ast/transform/packed_vec3.cc",
    "src/tint/ast/transform/packed_vec3.h",
    "src/tint/ast/transform/pad_structs.cc",
    "src/tint/ast/transform/pad_structs.h",
    "src/tint/ast/transform/preserve_padding.cc",
    "src/tint/ast/transform/preserve_padding.h",
    "src/tint/ast/transform/promote_initializers_to_let.cc",
    "src/tint/ast/transform/promote_initializers_to_let.h",
    "src/tint/ast/transform/promote_side_effects_to_decl.cc",
    "src/tint/ast/transform/promote_side_effects_to_decl.h",
    "src/tint/ast/transform/remove_continue_in_switch.cc",
    "src/tint/ast/transform/remove_continue_in_switch.h",
    "src/tint/ast/transform/remove_phonies.cc",
    "src/tint/ast/transform/remove_phonies.h",
    "src/tint/ast/transform/remove_unreachable_statements.cc",
    "src/tint/ast/transform/remove_unreachable_statements.h",
    "src/tint/ast/transform/renamer.cc",
    "src/tint/ast/transform/renamer.h",
    "src/tint/ast/transform/robustness.cc",
    "src/tint/ast/transform/robustness.h",
    "src/tint/ast/transform/simplify_pointers.cc",
    "src/tint/ast/transform/simplify_pointers.h",
    "src/tint/ast/transform/single_entry_point.cc",
    "src/tint/ast/transform/single_entry_point.h",
    "src/tint/ast/transform/spirv_atomic.cc",
    "src/tint/ast/transform/spirv_atomic.h",
    "src/tint/ast/transform/std140.cc",
    "src/tint/ast/transform/std140.h",
    "src/tint/ast/transform/substitute_override.cc",
    "src/tint/ast/transform/substitute_override.h",
    "src/tint/ast/transform/texture_1d_to_2d.cc",
    "src/tint/ast/transform/texture_1d_to_2d.h",
    "src/tint/ast/transform/transform.cc",
    "src/tint/ast/transform/transform.h",
    "src/tint/ast/transform/truncate_interstage_variables.cc",
    "src/tint/ast/transform/truncate_interstage_variables.h",
    "src/tint/ast/transform/unshadow.cc",
    "src/tint/ast/transform/unshadow.h",
    "src/tint/ast/transform/utils/get_insertion_point.cc",
    "src/tint/ast/transform/utils/get_insertion_point.h",
    "src/tint/ast/transform/utils/hoist_to_decl_before.cc",
    "src/tint/ast/transform/utils/hoist_to_decl_before.h",
    "src/tint/ast/transform/var_for_dynamic_index.cc",
    "src/tint/ast/transform/var_for_dynamic_index.h",
    "src/tint/ast/transform/vectorize_matrix_conversions.cc",
    "src/tint/ast/transform/vectorize_matrix_conversions.h",
    "src/tint/ast/transform/vectorize_scalar_matrix_initializers.cc",
    "src/tint/ast/transform/vectorize_scalar_matrix_initializers.h",
    "src/tint/ast/transform/vertex_pulling.cc",
    "src/tint/ast/transform/vertex_pulling.h",
    "src/tint/ast/transform/while_to_loop.cc",
    "src/tint/ast/transform/while_to_loop.h",
    "src/tint/ast/transform/zero_init_workgroup_memory.cc",
    "src/tint/ast/transform/zero_init_workgroup_memory.h",
    "src/tint/transform/manager.cc",
    "src/tint/transform/manager.h",
    "src/tint/transform/transform.cc",
    "src/tint/transform/transform.h",

    # From dawn/src/tint/BUILD.gn:libtint_ast_hdrs
    "src/tint/ast/accessor_expression.h",
    ...
    "src/tint/ast/break_if_statement.h",
    ...
    "src/tint/ast/diagnostic_rule_name.h",
    ...
    "src/tint/ast/must_use_attribute.h",
    "src/tint/ast/node.h",
    ...
    "src/tint/ast/templated_identifier.h",
    ...
    # From dawn/src/tint/BUILD.gn:libtint_ast_src
    "src/tint/ast/accessor_expression.cc",
    ...
    "src/tint/ast/break_if_statement.cc",
    ...
    "src/tint/ast/diagnostic_rule_name.cc",
    ...
    "src/tint/ast/must_use_attribute.cc",
    ...
    "src/tint/ast/templated_identifier.cc",
    "src/tint/ast/type.cc",
    ...
    # From dawn/src/tint/BUILD.gn:libtint_builtins_src
    "src/tint/builtin/access.cc",
    ...
    "src/tint/builtin/builtin_value.h",
    "src/tint/builtin/diagnostic_rule.cc",
    "src/tint/builtin/diagnostic_rule.h",
    "src/tint/builtin/diagnostic_severity.cc",
    "src/tint/builtin/diagnostic_severity.h",
    "src/tint/builtin/extension.cc",
    "src/tint/builtin/extension.h",
    "src/tint/builtin/fluent_types.h",
    ...
    "src/tint/builtin/number.cc",
    "src/tint/builtin/number.h",
    ...
    "src/tint/sem/break_if_statement.cc",
    "src/tint/sem/break_if_statement.h",
    ...
    "src/tint/sem/function_expression.cc",
    "src/tint/sem/function_expression.h",
    ...
    "src/tint/type/numeric_scalar.cc",
    "src/tint/type/numeric_scalar.h",
    ...
    "src/tint/type/scalar.cc",
    "src/tint/type/scalar.h",
    ...
    "src/tint/type/u32.h",
    "src/tint/type/unique_node.cc",
    "src/tint/type/unique_node.h",
    ...
    "src/tint/constant/value.cc",
    "src/tint/constant/value.h",

    # From dawn/src/tint/BUILD.gn:libtint_reader_src
    ...
    "src/tint/writer/ast_text_generator.cc",
    "src/tint/writer/ast_text_generator.h",
    ...
    "src/tint/reader/spirv/attributes.h",
